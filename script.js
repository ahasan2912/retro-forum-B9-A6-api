    ...
    posts.forEach((post)=> {
        ...
        <div class="p-6 lg:p-12 flex gap-6 lg:flex-row flex-col items-center lg:items-start bg-[#F3F3F5] rounded-3xl">
            ...
            <div class="space-y-4 w-full">
                ...
                <p class="opacity-40" hasanhabib2912@gmail.com>${post.description}</p>
...
const markAsRead = (description,view_count) => {
    ...
    const div = document.createElement('div');
    div.innerHTML = `
    <div class="flex justify-between p-4 lg:p-2 bg-white rounded-xl items-center gap-2">
        <div class="lg:w-4/5 w-11/12 p-2">
            <p>${description}</p>
        </div>
